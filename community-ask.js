    ...
    wrap.innerHTML =
      '<div class="ca-box">' +
        '<div id="caContent">' +
          ...
          '<h2 class="ca-title">חיפשתם משהו ולא מצאתם? מצאתם שגיאה?</h2>' +
          '<p class="ca-text">גו לונדון נבנה בשביל הקהילה הישראלית שמתכננת לונדון, ולא בשביל אף אחד אחר. ' +
            'אם יש מקום ששווה להוסיף, או אם משהו שכתוב כאן כבר לא מדויק, תכתבו לנו. ' +
            'אנחנו פה להשתפר ולהתאים את עצמנו לצרכים שלכם.</p>' +
